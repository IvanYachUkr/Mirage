...
from contracts import COUNTRIES, DIRECTOR_STYLES, GENRES, STYLE_TAGS
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Company generator for test30")
