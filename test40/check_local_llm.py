#!/usr/bin/env python3
"""Small local-LLM smoke check for lab/cluster runs."""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Verify that the configured local LLM endpoint can answer JSON prompts.")
    parser.add_argument("--model", default=None, help="Model name registered by the local server.")
