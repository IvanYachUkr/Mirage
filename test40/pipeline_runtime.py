...
class LLMSettings:
    ...
    artifact_bulk_model: str = "gemini-3.1-flash-lite-preview"
    artifact_mid_model: str = "gemini-3.1-flash-lite-preview"
    artifact_pro_model: str = "gemini-3.1-pro-preview"
