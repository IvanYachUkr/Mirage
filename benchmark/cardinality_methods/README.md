...
- `archives/`: downloaded source archives used to create the staged folders.
...
The run at `runs/test40_v10_ce_full_20260426_130414` includes the first
reusable learned-method executions:
...
- MSCN exact-JOB real-bitmap run trains for ten CPU epochs over real
  PostgreSQL-derived materialized sample bitmaps. See
  `runs/test40_v10_ce_full_20260426_130414/learned_methods_actual_run_report.md`.
