"""V19: Convert synthetic movie data into JOB/IMDB-compatible CSVs (full 21-table core).

info_type IDs are aligned to the real IMDB info_type table (113 rows).
Custom synthetic-only info types use IDs 200+ to avoid collisions.
"""
