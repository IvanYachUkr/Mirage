...
def _load_years(base_dir: Path) -> tuple[int, int]:
    ...
    try:
        ...
        return 1975, 2025
    return resolve_year_bounds(years=df.get("year", []), fallback_start=1975, fallback_end=2025)
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Generate structured world policy for test27.")
