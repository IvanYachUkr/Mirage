...
def run_verification(base_dir: str = None):
    ...
    cast = pd.read_csv(os.path.join(base_dir, "cast_info.csv"))
    md = pd.read_csv(os.path.join(base_dir, "movie_directors.csv"))
    mc = pd.read_csv(os.path.join(base_dir, "movie_companies.csv"))
    mk = pd.read_csv(os.path.join(base_dir, "movie_keyword.csv"))
    ...
    if 'pop_weight' in persons.columns:
        ...
        enriched_path = os.path.join(base_dir, "persons_enriched.csv")
        if os.path.exists(enriched_path):
            ep = pd.read_csv(enriched_path)
