"""Load extra_edges.csv into PostgreSQL edges table for imdb_v17."""
import psycopg2
import csv
import time
...
def main():
    ...
    edges_path = 'imdb_schema/extra_edges.csv'
    ...
    # Load data
    print('Loading extra_edges.csv (7.3M rows)...', flush=True)
    t0 = time.time()
    ...
    n = cur.fetchone()[0]
    print(f'Loaded edges: {n:,} rows in {time.time()-t0:.1f}s')
